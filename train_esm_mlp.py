...
parser.add_argument('-hls',
                    ...
                    default="(64,)",
                    type=str,
                    help='hidden layer sizes of MLP')      
...
def main(args):
    ...
    with open(sweep_log_path, 'a') as f:
        f.write('Test metrics:' + str(test_metrics.values()) + '\n')
...
if __name__ == '__main__':
    ...
    task_name = 'esm_mlp' + '_' + model_short + '_' + f'rmt{args.remove_top_layers}' + '_' + f'lr{args.learning_rate}' + '_' + f"hls{args.hidden_layer_sizes}" + '_' + f'f{args.num_layers}'
